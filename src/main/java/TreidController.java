...
public class TreidController {

    static int yourCapital = 150000;
    ...
    static int[] users = {12000, 53000, 25000, 38000, 143200, 72500, 610200, 82900, 26000, 299000,143200,72500,500500,15000,156000};
